...
cljs.core.UUID;
var example = {hello:{}};
example.hello.to_js = function to_js(b) {
    ...
    cljs.core.dorun.call(null, function() {
      return function e(b) {
        return new cljs.core.LazySeq(null, !1, function() {
          for(;;) {
            if(cljs.core.seq.call(null, b)) {
              var g = cljs.core.first.call(null, b), h = cljs.core.nth.call(null, g, 0, null), g = cljs.core.nth.call(null, g, 1, null);
              return cljs.core.cons.call(null, c[cljs.core.name.call(null, h)] = to_js.call(null, g), e.call(null, cljs.core.rest.call(null, b)))
            }
            return null
          }
        }, null)
  ...
  return cljs.core._EQ_.call(null, cljs.core.type.call(null, b), cljs.core.type.call(null, cljs.core.PersistentVector.EMPTY)) ? cljs.core.apply.call(null, cljs.core.array, cljs.core.map.call(null, to_js, b)) : b
};
example.hello.filename = "kitty.jpg";
example.hello.moon = new PhiloGL.O3D.Sphere(example.hello.to_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'nlat", "\ufdd0'nlong", "\ufdd0'radius", "\ufdd0'textures"], {"\ufdd0'nlat":30, "\ufdd0'nlong":30, "\ufdd0'radius":2, "\ufdd0'textures":example.hello.filename})));
example.hello.last_pos = cljs.core.atom.call(null, cljs.core.PersistentVector.fromArray([0, 0], !0));
example.hello.on_drag_start = function(a) {
  return cljs.core.swap_BANG_.call(null, example.hello.last_pos, cljs.core.constantly.call(null, cljs.core.PersistentVector.fromArray([a.x, a.y], !0)))
};
example.hello.cam_ob = cljs.core.atom.call(null, null);
example.hello.on_drag_move = function(a) {
  var a = cljs.core.PersistentVector.fromArray([a.x, a.y], !0), b = cljs.core.vec.call(null, cljs.core.map.call(null, cljs.core._, a, cljs.core.deref.call(null, example.hello.last_pos)));
  example.hello.moon.rotation.y += b.call(null, 0) / 100;
  example.hello.moon.rotation.x += b.call(null, 1) / 100;
  example.hello.moon.update();
  return cljs.core.swap_BANG_.call(null, example.hello.last_pos, cljs.core.constantly.call(null, a))
};
example.hello.on_mouse_wheel = function(a) {
  cljs.core.deref.call(null, example.hello.cam_ob).position.z = cljs.core.deref.call(null, example.hello.cam_ob).position.z + a.wheel;
  return cljs.core.deref.call(null, example.hello.cam_ob).update()
};
example.hello.on_error = function() {
  return alert("There was an error creating the app.")
};
example.hello.init = function(a, b, c) {
  c.clearColor(0, 0, 0, 1);
  c.clearDepth(1);
  c.enable(c.DEPTH_TEST);
  c.depthFunc(c.LEQUAL);
  c.viewport(0, 0, a.width, a.height);
  return b.add(example.hello.moon)
};
example.hello.draw = function(a, b, c) {
  c.clear(c.COLOR_BUFFER_BIT | c.DEPTH_BUFFER_BIT);
  b.config.lights = example.hello.to_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'enable", "\ufdd0'ambient", "\ufdd0'directional"], {"\ufdd0'enable":!0, "\ufdd0'ambient":cljs.core.ObjMap.fromObject(["\ufdd0'r", "\ufdd0'g", "\ufdd0'b"], {"\ufdd0'r":0.2, "\ufdd0'g":0.2, "\ufdd0'b":0.2}), "\ufdd0'directional":cljs.core.ObjMap.fromObject(["\ufdd0'color", "\ufdd0'direction"], {"\ufdd0'color":cljs.core.ObjMap.fromObject(["\ufdd0'r", "\ufdd0'g", "\ufdd0'b"], {"\ufdd0'r":0.8, "\ufdd0'g":0.8, "\ufdd0'b":0.8}), 
  "\ufdd0'direction":cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'z"], {"\ufdd0'x":-1, "\ufdd0'y":-1, "\ufdd0'z":-1})})}));
  return b.render()
};
example.hello.on_load = function(a) {
  var b = a.canvas, c = a.scene, d = a.gl, a = a.camera;
  example.hello.init.call(null, b, c, d);
  cljs.core.reset_BANG_.call(null, example.hello.cam_ob, a);
  return function f() {
    example.hello.draw.call(null, b, c, d);
    return PhiloGL.Fx.requestAnimationFrame(f)
  }.call(null)
};
example.hello.camera = cljs.core.ObjMap.fromObject(["\ufdd0'position"], {"\ufdd0'position":cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'z"], {"\ufdd0'x":0, "\ufdd0'y":0, "\ufdd0'z":-7})});
example.hello.textures = cljs.core.ObjMap.fromObject(["\ufdd0'src", "\ufdd0'parameters"], {"\ufdd0'src":cljs.core.PersistentVector.fromArray([example.hello.filename], !0), "\ufdd0'parameters":cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":"TEXTURE_MAG_FILTER", "\ufdd0'value":"LINEAR"}), cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":"TEXTURE_MIN_FILTER", "\ufdd0'value":"LINEAR"}), cljs.core.ObjMap.fromObject(["\ufdd0'name", 
"\ufdd0'value"], {"\ufdd0'name":"TEXTURE_WRAP_S", "\ufdd0'value":"CLAMP_TO_EDGE"}), cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'value"], {"\ufdd0'name":"TEXTURE_WRAP_T", "\ufdd0'value":"CLAMP_TO_EDGE"})], !0)});
example.hello.webgl_start = function() {
  return PhiloGL("gl-canvas", example.hello.to_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'camera", "\ufdd0'textures", "\ufdd0'events", "\ufdd0'onError", "\ufdd0'onLoad"], {"\ufdd0'camera":example.hello.camera, "\ufdd0'textures":example.hello.textures, "\ufdd0'events":cljs.core.ObjMap.fromObject(["\ufdd0'onDragStart", "\ufdd0'onDragMove", "\ufdd0'onMouseWheel"], {"\ufdd0'onDragStart":example.hello.on_drag_start, "\ufdd0'onDragMove":example.hello.on_drag_move, "\ufdd0'onMouseWheel":example.hello.on_mouse_wheel}), 
  "\ufdd0'onError":example.hello.on_error, "\ufdd0'onLoad":example.hello.on_load})))
};
